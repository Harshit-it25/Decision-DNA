          ...
          <div className="mt-8 pt-6 border-t border-slate-800/50">
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              <span 
                ...
                className="px-2 py-1 bg-slate-800/50 hover:bg-indigo-500/20 border border-slate-700 hover:border-indigo-500/40 rounded text-[9px] text-slate-400 hover:text-indigo-200 cursor-pointer transition-all"
